...
class CardController extends Yaf\Controller_Abstract  {
    ...
    public function listAction(){
        ...
        if(!empty($cardData)){
            ...
            $sqlstrone = "SELECT c.id,u.avatar,u.nick_name,u.id as u_id,u.uid,c.lbs,u.competence,c.content,c.card_pic,c.click as click_num FROM zs_card as c LEFT JOIN zs_user as u ON u.id = c.u_id WHERE c.t_id = {$t_id} and u.competence = '官方小宠爱' ORDER BY c.id DESC LIMIT 0,1";
            ...
            $sqlstr = "SELECT c.id,u.avatar,u.nick_name,u.id as u_id,u.uid,c.lbs,u.competence,c.content,c.card_pic,c.click as click_num FROM zs_card as c LEFT JOIN zs_user as u ON u.id = c.u_id WHERE c.t_id = {$t_id} and u.competence <> '官方小宠爱' ORDER BY c.id DESC LIMIT {$start},{$showPage}";
            ...
            echo json_encode(array_merge($pageone,$page));
        }else{
            echo json_encode(["code"=>1100,"message"=>"没有找到此帖"]);
        }
    }
